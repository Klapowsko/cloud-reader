...
export default function ChaptersPanel({
  ...
  return (
    <>
      ...
      <div className={`fixed md:absolute left-0 top-14 md:top-16 bottom-0 w-full md:w-64 bg-white border-r border-gray-200 shadow-lg z-30 md:z-20 overflow-y-auto transform transition-transform duration-300 ${
